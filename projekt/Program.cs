        ...
        static void Main(string[] args)
        {
            ...
            while (logowanie == true)
            {
                ...
                if (konto == 1)
                {
                    ...
                    logowanie = false;
                    if (MySqlzap.get_status(login))//sprawdza rodzaj kąta
                    {
                        typ = "admin";
                    }
                    else
            ...
            if (typ == "klient")
            {
                    ...
                    else if (rodzaj == 2)
                    {
                        do
                        {
                            ...
                            try
                            {
                                ...
                                //teraz trzeba zrobic podział na polska zagranica
                ...
                //Obliczanie ilosci dni pobytu

                //ilosc_dni = MySqlzap.pobierz_ilosc_dni(wybor);
                    ...
                    if (wycieczki == 1)
                    {
                        ...
                        if (w1 == "t")
                        {
                            do
                            {
                                ...
                                try
                                {
                                    int.Parse(od_kiedy.Substring(0, 4));
                                    int.Parse(od_kiedy.Substring(5, 2));
                                    int.Parse(od_kiedy.Substring(8, 2));
                                }
                                catch
                                {
                                    czy_liczba = false;
                            ...
                            } while (!czy_liczba || od_kiedy[4] != '-' || od_kiedy[7] != '-');
                            do
                            {
                                ...
                                try
                                {
                                    int.Parse(do_kiedy.Substring(0, 4));
                                    int.Parse(do_kiedy.Substring(5, 2));
                                    int.Parse(do_kiedy.Substring(8, 2));
                                }
                                catch
                                {
                                    czy_liczba = false;
                            ...
                            } while (!czy_liczba || do_kiedy[4] != '-' || do_kiedy[7] != '-');
